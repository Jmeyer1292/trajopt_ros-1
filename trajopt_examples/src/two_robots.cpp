...
ProblemConstructionInfo cppMethod()
{
  ...
  joint_vel->coeffs = std::vector<double>(14, 10.0);
  ...
  joint_acc->coeffs = std::vector<double>(14, 2.0);
  ...
  joint_jerk->coeffs = std::vector<double>(14, 1.0);
...
int main(int argc, char** argv)
{
  ...
  ipos["left_joint_a1"] = 0.785398;
  ipos["left_joint_a2"] = 0.4;
  ipos["left_joint_a3"] = 0.0;
  ipos["left_joint_a4"] = -1.9;
  ipos["left_joint_a5"] = 0.0;
  ipos["left_joint_a6"] = 1.0;
  ipos["left_joint_a7"] = 0.0;

  ipos["right_joint_a1"] = -0.785398;
  ipos["right_joint_a2"] = 0.4;
  ipos["right_joint_a3"] = 0.0;
  ipos["right_joint_a4"] = -1.9;
  ipos["right_joint_a5"] = 0.0;
  ipos["right_joint_a6"] = 1.0;
  ipos["right_joint_a7"] = 0.0;
